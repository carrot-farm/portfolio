...
class AboutContents extends Component {
   ...
   setScene = ()=>{
      ...
      for(;i<len;i++){
         this.tls[i] = new TimelineMax()
            .staggerFromTo(wrappers[i].querySelectorAll('.ani'), 1,{
               autoAlpha: 0,
               x: '-100%',
            },{
               autoAlpha: 1,
   ...
   render() {
      return (
         <div id="section_about-contents-root"
            className={cx('section_about-contents-root section-start')}
            ref={el=>this.rootEl=el}
         >
            {/* 소개 */}
            <div className={cx('section_introduction article-section article-section-0')}>
               <div className={cx('introduction-container container')}>
                  <div className={cx('wrapper ')}>
                     <div className={cx('section-name ani')}>
                        <span className={cx('h3-deco')}></span>
                        <h3>INTRODUCTION</h3>
                     </div>
                     <p className={cx('ani')}>
                        저는 풀스택을 지향하는 개발자로<br />
                        책임감을 최우선으로 두고 <br />
                        디자인에서 개발까지 폭넓은 시각을 바탕으로 <br />
                        언제나 고객이 원하는 최고의 제품을<br />
                        만들기 위해 최선을 다하고 있습니다.
                     </p>
                  </div>
               </div>
            ...
            {/* 스택 */}
            <div className={cx('section_stacks article-section clearfix  article-section-1')}>
            ...
            {/* 자격증 */}
            <div className={cx('section_qualification article-section clearfix  article-section-2')}>
               <div className={cx('stacks-container container ')}>
                  <div className={cx('wrapper ')}>
                     <div className={cx('section-name ani')}>
                        <span className={cx('h3-deco')}></span>
            ...
            {/* work expreience */}
            <div className={cx('section_work-expreience article-section clearfix  article-section-3')}>
               <div className={cx('stacks-container container ')}>
                  <div className={cx('wrapper right-wrapper ')}>
                     <div className={cx('section-name ani')}>
                        <span className={cx('h3-deco')}></span>
                     ...
                     <ul>
                        ...
                        <li className={cx('second-li ani')}>
                           ...
                           <p>
                              병원내 개발팀으로 입사.<br />
                              (원내 ERP와 홈페이지 개발 및 유지보수)<br />
                              팀이라고 해도 혼자여서 <br />
                              디자인과 퍼블리싱, 개발을 주도적으로 <br />
                              할 수 있어 매우 만족 스러웠고<br />
                              퇴근 후 에는 지인들을 통해 <br />
