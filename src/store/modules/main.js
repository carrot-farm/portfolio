      ...
      Map({
         ...
         description: Map({
            ...
            list: List([
               ...
               Map({text: '개인적으로 사용중.'}),
               Map({text: '추후 기능 추가 후 react native를 사용해 앱으로 포팅 예정.'}),
            ])
         }),
         links: List([
            Map({
      ...
      Map({
         ...
         description: Map({
            ...
            list: List([
               ...
               Map({text: 'WEB + HYBRID'}),
               Map({text: '너무 만들고 싶어서 회사 그만두고 창업. 노력 했지만 잘안됨.'}),
               Map({text: '내부 서버 다 걷어 내서 핵심 기능은 작동안함.'}),
         ...
         links: List([
            ...
            Map({
               category: 'android',
               link: 'https://play.google.com/store/apps/details?id=com.murian.dongneand',
               text: '동네엔'
            }),
         ]),
         participationRate: 100,
